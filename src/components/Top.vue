<template>
  <div class="top">
    ...
    <p>ad &gt;&gt;</p>
    <div id="zt_456562_1" style="display:show"> 
    </div>
    <p>&gt;&gt; ad</p>
    ...
    <p>ad &gt;&gt;</p>
    <div id="zt_456562_2" style="display:show"> 
    </div>
    <p>&gt;&gt; ad</p>
    ...
    <p>ad &gt;&gt;</p>
    <div id="zt_456562_3" style="display:show"> 
    </div>
    <p>&gt;&gt; ad</p>
  ...
  methods: {
    top_showad: function () {
      ...
      window.zd_get_placements = function() {
        zmt_mtag = window.zmt_get_tag(2117,"456562");
